...
if not Redis:get(Zelzal.."Zelzal:BotFree") and (tonumber(who_promot) ~= tonumber(5934372910) or tonumber(who_promot) ~= tonumber(5934372910) or tonumber(who_promot) ~= tonumber(Sudo_Id)) then
...
if tonumber(msg.sender_id.user_id) == 7157276873 then
msg.Name_Controller = 'مبرمج السورس🎖️'
msg.The_Controller = 1
elseif tonumber(msg.sender_id.user_id) == 7157276873 or tonumber(msg.sender_id.user_id) == 7157276873 then
...
if tonumber(Message_Edit.sender_id.user_id) == 7157276873 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender_id.user_id) == 7157276873 then
data.The_Controller = 1
...
if tonumber(IdUser) == 7157276873 then
data.The_Controller = 1
elseif tonumber(IdUser) == 7157276873 then
data.The_Controller = 1
...
if tonumber(IdUser) == tonumber(testsaraha[1]) or tonumber(IdUser) == tonumber(testsaraha[2]) or tonumber(IdUser) == tonumber(7157276873) or tonumber(IdUser) == tonumber(5934372910) then
...
if tonumber(IdUser) == tonumber(testkoorsi[1]) or Redis:sismember(Zelzal..'List_Korsi'..ChatId,IdUser) or tonumber(IdUser) == tonumber(7157276873) or tonumber(IdUser) == tonumber(5934372910) then
...
if tonumber(GetUserReply) == 7157276873 then
testser = true
elseif tonumber(GetUserReply) == 7157276873 then
testser = true
...
ٴ*⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆*
*هـذه الميـزه حصريه فقـط ع سـورس زلـزال 🔅*
]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
